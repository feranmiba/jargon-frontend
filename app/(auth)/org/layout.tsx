...
export default function AuthLayout({
  ...
  const getContent = () => {
    if (pathname?.includes("signup")) {
      return {
        title: "Request data safely and securely",
        subtitle: "Join thousands of companies requesting dtata and keeping their customer data safe with enterprise-grade encryption",
        features: [
